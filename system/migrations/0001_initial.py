# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-06-17 16:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='task_list',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='system.TaskList'),
        ),
        migrations.AddField(
            model_name='comment',
            name='task',
        ...
        migrations.AlterUniqueTogether(
            name='comment',
            unique_together=set([('task', 'email_message_id')]),
        ),
    ]
